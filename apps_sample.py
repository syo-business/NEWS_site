...
def index():
    ...
    return render_template('index.html',text_business=news_business,text_entertainment=news_entertainment,text_general=news_general,image_business=img_business,image_entertainment=img_entertainment,image_general=img_general,link_business=url_business,link_entertainment=url_entertainment,link_general=url_general,context_business=mylist_business,context_entertainment=mylist_entertainment,context_general=mylist_general) # tempaltesフォルダのhtmlファイルを返している
